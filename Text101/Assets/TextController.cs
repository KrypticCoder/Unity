...
public class TextController : MonoBehaviour {
	...
	private enum States {cell, mirror, sheets_0, lock_0, cell_mirror, sheets_1, lock_1, 
		corridor_0, stairs_0, stairs_1, stairs_2, courtyard, floor, corridor_1, 
	...
	void cell(){
		text.text = "You wake up to the sound of water tapping on the floor. " + 
			"You find youself in a prison cell surrounded by walls of concrete. " + 
			"Inside the cell, there are some dirty sheets on the bed, a mirror on the wall" + 
			", and no way out. The door is locked from the outside. You must escape. \n\n" + 
	...
	void sheets_0(){
		text.text = "You can't believe you sleep in these things. " +
			"Scraps of rags at best. Surely, it's time someone changed them. " +
	...
	void cell_mirror(){
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
			...
			"Press S to view Sheets again\n" + 
			"Press L to view Lock again";
